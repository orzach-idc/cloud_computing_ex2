...
export AWS_DEFAULT_REGION=$(sudo sudo aws configure get aws_default_region)

# run elb file
sudo python3 elb.py $AWS_ACCESS_KEY_ID $AWS_SECRET_ACCESS_KEY $AWS_DEFAULT_REGION
